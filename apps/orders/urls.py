...
urlpatterns = [
    ...
    path('add/<int:product_id>/', views.add_to_cart, name='add'),  # лишаємо, якщо десь використовуєш
    path('add-variant/<int:variant_id>/', views.add_variant_to_cart, name='add_variant'),  # нове
